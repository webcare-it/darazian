...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="col-lg-2 ml-auto">
                <select class="form-control aiz-selectpicker" name="order_type" id="order_type">
                    ...
                    <option value="manual_order" @if ($order_type == 'manual_order') selected @endif>{{translate('Manual Orders')}}</option>
                    <option value="website" @if ($order_type == 'website') selected @endif>{{translate('Website Orders')}}</option>
                </select>
            </div>
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <input type="text" class="form-control" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Search by Order Code, Phone, Name or Address') }}">
    ...
    <!--                    <td>
                        ...
                        @php
                            $fraudPhone = $order->phone_number ?? optional(json_decode($order->shipping_address))->phone ?? optional($order->user)->phone ?? '';
                            $fraudCheckerRoute = $fraudPhone ? route('fraud_checker', ['phone' => $fraudPhone]) : route('fraud_checker');
                        @endphp
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ $fraudCheckerRoute }}" title="{{ translate('Fraud Checker') }}">
                            ...
                            <button type="button" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('orders.destroy', $order->id)}}" title="{{ translate('Delete') }}">
