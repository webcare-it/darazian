        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('pos_system'))
                    @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions))))
                        <li class="aiz-side-nav-item">
            ...
            <!-- Product -->
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                ...
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{route('admin.landing-pages.create')}}">
                                    <span class="aiz-side-nav-text">{{translate('Add New Landing Page')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('admin.landing-pages.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.landing-pages.index', 'admin.landing-pages.create', 'admin.landing-pages.edit']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Landing Pages') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions))))
                            <li class="aiz-side-nav-item">
            ...
            <!-- Refund addon -->
                @if (addon_is_activated('refund_request'))
                    @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions))))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
            ...
            <!-- Customers -->
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
            ...
            <!-- Sellers -->
                ...
                @endif
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                ...
                @endif
            <!-- Reports -->
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-file-alt aiz-side-nav-icon"></i>
            ...
            <!-- marketing -->
                @if(Auth::check() && Auth::user() && (Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions))))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-bullhorn aiz-side-nav-icon"></i>
