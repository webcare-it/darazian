...
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center justify-content-center" style="background-image: url({{ uploaded_asset(get_setting('admin_login_background')) }});">
    <div class="container">
        <div class="row">
